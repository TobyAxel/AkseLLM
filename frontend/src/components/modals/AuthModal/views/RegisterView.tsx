    ...
    return (
        <>
            ...
            <div className="space-y-2">
                <label htmlFor="username" className="block text-neutral-300 text-sm font-medium">Username</label>
            ...
            {/* Email Input */}
            <div className="space-y-2">
                <label htmlFor="email" className="block text-neutral-300 text-sm font-medium">Email</label>
                <div className="relative">
            ...
            {/* Password Input */}
            <div className="space-y-2">
                <label htmlFor="password" className="block text-neutral-300 text-sm font-medium">Password</label>
                <div className="relative">
            ...
            <div className="space-y-2">
                <label htmlFor="confirmPassword" className="block text-neutral-300 text-sm font-medium">Confirm Password</label>
                <div className="relative">
                    <FiLock className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500" size={18} />
                    <input
                        id="confirmPassword"
