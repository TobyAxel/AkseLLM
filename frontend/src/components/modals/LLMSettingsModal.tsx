                        ...
                        <div className="p-4 space-y-4 border-t border-neutral-700/60 bg-neutral-900/20">
                            ...
                            <div className="flex items-center justify-between py-1">
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 focus:outline-none cursor-pointer ${(config?.stream ?? true) ? "bg-neutral-500" : "bg-neutral-700"}`}
                                >
                                    <span className={`inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform duration-200 ${(config?.stream ?? true) ? "translate-x-6" : "translate-x-1"}`} />
                                </button>
                            </div>
